...
class BrickCount {
    constructor(_stage) {
        ...
        playButtonLabel3.height = 100;
        playButtonLabel3.buttonMode = true;
        playButtonLabel3.interactive = true;
        playButtonLabel3.on("pointerup", this.nextScene.bind(this)); //startGame is a function reference
        ...
        playButtonLabel4.height = 100;
        playButtonLabel4.buttonMode = true;
        playButtonLabel4.interactive = true;
        playButtonLabel4.on("pointerup", this.gameOver.bind(this)); //startGame is a function reference
